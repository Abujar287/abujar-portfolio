...
const experiences = [
  {
    ...
    description: 'Responsible for business data analysis, SQL reporting, BI dashboards, operational performance analysis and data-driven decision support.',
    highlights: [
  ...
  },
  {
    ...
    company: 'Chaldal PLC',
    description: 'Supported business monitoring and operational decision-making through dashboards, reporting automation and business data analysis.',
    highlights: [
  ...
  },
  {
    ...
    company: 'Shikho PLC',
    description: 'Managed customer communication, enrollment activities and sales support through effective student and parent engagement.',
    highlights: [
...
const navigation = ['home', 'about', 'skills', 'experience', 'achievements', 'education', 'contact']
...
function App() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(entries => {
      entries.forEach(entry => {
        if (entry.isIntersecting) setTechnicalVisible(true)
      })
    }, { threshold: 0.18 })
    ...
    <div className="portfolio">
      <nav className="navbar">
        ...
        <div className="nav-links">
          {navigation.map(item => (
            <button key={item} className={activeSection === item ? 'active' : ''} onClick={() => scrollTo(item)}>
              {item}
            </button>
          ))}
        </div>
      ...
      <main>
          ...
          <div className="about-grid">
            <div>
              <p className="large-text">
                Data & Business Insights Analyst with nearly 5 years of experience in Business Intelligence, Data Analytics, Reporting Automation, and Operational Performance Analysis.
              </p>
              <p>
                Proficient in SQL, Python, Advanced Excel, and BI tools to transform complex data into actionable insights, optimize business processes, and support data-driven decision-making.
              </p>
            </div>
        ...
        <section id="skills" className="section technical-section" ref={technicalRef}>
          <div className="section-title">
            <h2>Technical Skills</h2>
          </div>
          <div className={`technical-showcase ${technicalVisible ? 'technical-active' : ''}`}>
            ...
            <div className="technical-list">
              {heroSkills.map((skill, index) => (
                <div className="technical-item" key={skill.name} style={{ '--technical-delay': `${index * 0.12}s` }}>
                  <div className="technical-number">{String(index + 1).padStart(2, '0')}</div>
        ...
        <section className="section expertise-section">
          ...
          <div className="expertise-intro">
            <p>Data, technology and business expertise combined to build smarter decisions and scalable solutions.</p>
          </div>
          <div className="expertise-showcase">
            {expertiseGroups.map((group, index) => (
              <article className="expertise-item" key={group.title}>
                <div className="expertise-index">{String(index + 1).padStart(2, '0')}</div>
        ...
        <section id="contact" className="section contact">
          <div className="contact-content">
            ...
            <p>Interested in data analytics, business intelligence, automation or collaboration? Let's connect.</p>
