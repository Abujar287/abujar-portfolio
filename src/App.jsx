      ...
      <main>
          ...
          <div className="about-grid">
            <div>
              <p className="large-text">
                Data Analyst with nearly 5 years of experience in Business
                Intelligence, Data Analytics, Reporting Automation, and Business
                Performance Analysis.
              </p>

              <p>
                Experienced in analyzing operational and customer data, developing
                KPI dashboards, automating reporting workflows, and delivering
                insights for business decision-making. Proficient in SQL, Advanced
                Excel, Python, and BI tools, with a strong focus on improving
                processes, performance, and data-driven operations.
              </p>
            </div>
        ...
        <section id="expertise" className="section expertise-section">
          ...
          <p className="expertise-intro">
            Data, technology and business expertise combined to turn complex data
            into clear insights, smarter decisions and scalable solutions.
          </p>
        ...
        <section id="contact" className="section contact">
          <div className="contact-content">
            ...
            <p>
              ...
              and reporting automation. Whether you have a question, a project,
